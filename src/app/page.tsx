...
import { Camera, QrCode, Trophy, ChevronRight, Leaf } from 'lucide-react';
...
export default function Home() {
  ...
  }, [user?.id, ecoActions]); // Reload when actions change
  ...
  const handleStartMission = async (mission: Mission) => {
    ...
    try {
      // In a real app, we would ask for a photo here
